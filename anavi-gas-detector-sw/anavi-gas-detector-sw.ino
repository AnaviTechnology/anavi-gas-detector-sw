...
void setup()
{
    ...
    Serial.println("ANAVI Gas Detector");
    drawDisplay("Gas Detector");
...
void mqttReconnect()
{
    ...
    for (int attempt = 0; attempt < 3; ++attempt)
    {
        ...
        const String clientId = "gas-detector-1";
        // Attempt to connect
...
void loop()
{
    ...
    if (sensorInterval <= (currentMillis - sensorPreviousMillis))
    {
        ...
        drawDisplay("Gas Detector", "Air quality:", air.c_str());
    }

    /*digitalWrite(pinCustom, HIGH);
    delay(500);
    digitalWrite(pinCustom, LOW);
    delay(500);*/
